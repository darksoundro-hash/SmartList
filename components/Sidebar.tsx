...
export const Sidebar: React.FC<SidebarProps> = ({ activePage }) => {
  ...
  const SidebarContent = () => {
    console.log("isMobileMenuOpen (inside SidebarContent):", isMobileMenuOpen);
    return (
      <>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className="font-medium text-base">H{item.label}</span>
              </Link>
            );
          })}
        </nav>
  ...
  console.log("isMobileMenuOpen (main render):", isMobileMenuOpen);
